...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an Anime themed group management bot. Join our support group - @DragonBallChatDB.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Son Goku to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🚑 Support Group",
                             url=f"https://t.me/DragonBallChatDB"),
                         InlineKeyboardButton(
                             text="🔔 Updates Channel",
                             url="https://t.me/SaiyansAssociation_Updates")
                     ],
                     [
                         InlineKeyboardButton(
